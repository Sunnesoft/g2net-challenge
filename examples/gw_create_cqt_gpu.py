...
if __name__ == '__main__':
    ...
    proc = CQTProcessor(mode=TfDevice.GPU, multidevice_strategy=False, verbose=True)
    ...
    proc.run(
        ...
        qrange=(4, 64), mismatch=0.05, time_range=(0.1, 1.9, 1e-2),
        freq_range=(50, 250, 1), img_size=(512, 512), shuffle_tasks=True
    )